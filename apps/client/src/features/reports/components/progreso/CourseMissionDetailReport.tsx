    ...
    >
      <Stack spacing={2} sx={{ height: "100%" }}>
        <HeaderReportPage
          ...
          description="Analiza el rendimiento y estadísticas de los alumnos en una misión particular."
          icon={<AssignmentIcon />}
          filters={filters}
          endpointPathPdf={`/reportes/cursos/${courseId}/progreso/detalle-mision/pdf`}
