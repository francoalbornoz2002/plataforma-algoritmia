    ...
    >
      <Stack spacing={2} sx={{ height: "100%" }}>
        <HeaderReportPage
          ...
          description="Consulta la distribución de usuarios por rol y estado en la plataforma."
          icon={<PeopleIcon />}
          filters={filters}
          endpointPathPdf="/reportes/usuarios/resumen/pdf"
          endpointPathExcel="/reportes/usuarios/resumen/excel"
          filenameExcel="resumen_usuarios.xlsx"
