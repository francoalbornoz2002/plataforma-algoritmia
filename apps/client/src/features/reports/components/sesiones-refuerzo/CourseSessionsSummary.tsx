  ...
  return (
    ...
    >
      <Stack spacing={2} sx={{ height: "100%" }}>
        <HeaderReportPage
          title="Resumen de Sesiones de Refuerzo"
          description="Analiza el impacto y la efectividad de las sesiones asignadas para mejorar el rendimiento de los alumnos."
          icon={<PsychologyIcon />}
          filters={{
            ...filters,
          ...
          endpointPathPdf={`/reportes/cursos/${courseId}/sesiones-refuerzo/resumen/pdf`}
          endpointPathExcel={`/reportes/cursos/${courseId}/sesiones-refuerzo/resumen/excel`}
          filenameExcel="resumen_sesiones.xlsx"
          disabled={!data}
        />
                ...
                <StatCard
                  ...
                  description={
                    <Box component="span" sx={{ display: "flex", gap: 1.5 }}>
                      ...
                      >
                        Sesiones Activas: {data.kpis.activas}
                      </Box>
                  ...
                  >
                    ...
                    <FormControl size="small" variant="standard">
                      <Select
                        ...
                        onChange={(e) =>
                          setChartGrouping2(e.target.value as any)
                        }
                        disableUnderline
                        sx={{ fontSize: "0.875rem", fontWeight: "bold" }}
                      >
