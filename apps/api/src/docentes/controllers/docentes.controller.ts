...
//TODO: Quitar alumno de aqui si ya no es necesario, pero permitimos Administrador para visualización de reportes
@Roles(roles.Docente, roles.Alumno, roles.Administrador)
@Controller('docentes')
